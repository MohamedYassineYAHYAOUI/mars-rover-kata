...
public class BackwardCommandsTest {
    ...
    public void should_return_correct_point_after_one_backward_movement(int initialX, int initialY, char initialDirection,
    ...
    public void should_return_correct_point_after_multiple_backwards(int initialX, int initialY, char initialDirection
            , int expectedX, int expectedY, String commands) {
        should_return_correct_point_after_one_backward_movement(initialX, initialY, initialDirection, expectedX, expectedY, commands);
    }
